...
public:
  ...
  bool begin(bool measBegin) { return begin(measBegin); }
  bool begin(bool measBegin, bool autoCalibrate) { return begin(measBegin, autoCalibrate); }
  bool begin(bool measBegin, bool autoCalibrate, bool skipStopPeriodicMeasurements) { return begin(measBegin, autoCalibrate, skipStopPeriodicMeasurements); }
  bool begin(bool measBegin, bool autoCalibrate, bool skipStopPeriodicMeasurements, bool pollAndSetDeviceType); //By default use Wire port
