...
const char INTL_LORA_UART_HINT[] PROGMEM = "Urban C6: TX GPIO22 / RX GPIO20, 115200. Serial Module: PROTO. Если dest задан — unicast protobuf Port 256 на этот узел, не в чат. Если пусто — ничего не шлётся.";
