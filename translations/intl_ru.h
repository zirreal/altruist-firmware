...
const char INTL_LORA_UART_HINT[] PROGMEM = "Urban C6: TX GPIO22 (контакт 6 CN4), RX GPIO20 (контакт 8), 115200. Serial Module: PROTO (не TEXTMSG). В личку Meshtastic шлёт core.v1.Message, PortNum 256. Префикс 0x01, если больше 218 байт — фрагменты 0x41. Получатель — node id радио шлюза.";
