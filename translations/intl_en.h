...
const char INTL_LORA_UART_HINT[] PROGMEM = "Urban C6: TX GPIO22 / RX GPIO20, 115200. Serial Module: PROTO. Destination set: unicast protobuf Port 256 to that node (not chat). Empty dest: nothing is sent.";
