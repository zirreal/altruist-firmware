...
const char INTL_LORA_UART_HINT[] PROGMEM = "Urban C6: TX GPIO22 (CN4 pin 6), RX GPIO20 (pin 8). Default 180 s (3 min); 120–300 s is typical for Meshtastic. Serial Module: enabled, TEXTMSG, 115200 (baud 11), timeout 1 s. Cross TX/RX and share GND.";
