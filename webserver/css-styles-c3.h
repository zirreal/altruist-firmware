...
@media screen and (min-width:721px){.app-sidebar{display:block;position:sticky;top:0;align-self:flex-start;max-height:100vh;overflow-y:auto;overscroll-behavior:contain}.app-layout .content-app{max-width:none;width:auto;margin:0;padding:16px 0 24px 20px;flex:1;min-width:0}}
