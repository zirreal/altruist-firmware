...
.app-topbar{padding:0;background:#0a0a0a;color:#fff;border-bottom:1px solid #1f1f1f;box-sizing:border-box;width:100%}
...
.app-topbar__tag{display:inline-flex;align-items:center;max-width:100%;padding:3px 8px;border-radius:999px;font-size:10px;font-weight:600;line-height:1.3;color:#b5b5b5;background:#171717;border:1px solid #333;text-decoration:none;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
...
.app-topbar__chip{display:flex;flex-direction:column;align-items:flex-start;gap:4px;min-width:0;padding:10px 12px;border-radius:12px;border:1px solid #2a2a2a;background:#141414;text-align:left;color:inherit;font:inherit;box-sizing:border-box}
.app-topbar__chip--send{gap:6px}
.app-topbar__chip--status{justify-content:center}
.app-topbar__chip--ok{border-color:rgba(52,199,89,.35);background:rgba(52,199,89,.08)}
.app-topbar__chip--warn{border-color:rgba(255,179,64,.4);background:rgba(255,179,64,.1)}
.app-topbar__chip--off{border-color:rgba(255,69,58,.35);background:rgba(255,69,58,.08)}
.app-topbar__chip--copy{cursor:pointer;transition:background .15s,border-color .15s}
.app-topbar__chip--copy:hover{background:#1b1b1b;border-color:#3a3a3a}
.app-topbar__chip-head{display:flex;align-items:center;justify-content:space-between;gap:8px;width:100%;min-width:0}
.app-topbar__chip-lbl{font-size:10px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;color:#888;line-height:1.2}
...
.app-topbar__chip-wifi{font-size:11px;font-weight:500;color:#8a8a8a;line-height:1.35;text-align:right;word-break:break-word;overflow-wrap:anywhere;min-width:0;flex:1}
.app-topbar__chip-sub{font-size:12px;font-weight:500;color:#c8c8c8;line-height:1.35;word-break:break-word}
.app-topbar__chip-sub--muted{color:#8a8a8a;font-size:11px}
.app-topbar__chip-sub--fw{color:#c8c8c8;font-size:11px;font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-weight:500;word-break:break-word;overflow-wrap:anywhere}
...
.app-topbar__send-row-lbl{font-size:12px;font-weight:600;color:#c8c8c8;line-height:1.3;flex-shrink:0}
...
.app-topbar__send-row-age{font-size:11px;font-weight:500;color:#8a8a8a;line-height:1.3;padding-left:0}
.app-topbar__send-row--muted .app-topbar__send-row-val{color:#8a8a8a;font-weight:500}
...
.app-topbar__chip-addr-lbl{color:#8a8a8a;font-size:11px;font-weight:600;letter-spacing:.04em;line-height:1.4;flex-shrink:0}
...
.app-topbar__chip-hint{font-size:11px;color:#7a7a7a;line-height:1.2}
.app-topbar__chip--copy:hover .app-topbar__chip-hint{color:#b0b0b0}
...
.app-shell .data-block__title{background:#f7f7f7;border-bottom:1px solid #e5e5e5;border-left:3px solid #111;padding:10px 12px;margin:0}
